...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 864, ; uint32_t number_of_aot_cache_entries
	i32 104, ; uint32_t number_of_shared_libraries
	i32 u0x020002bd, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06001a87, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001a86, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [864 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.99_name, ; name: libaot-netstandard.dll.so
		ptr null; void* handle
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.102_name, ; name: libaot-Mono.Android.dll.so
		ptr null; void* handle
	}, ; 4
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.96_name, ; name: libaot-System.Web.HttpUtility.dll.so
		ptr null; void* handle
	}, ; 19
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.103_name, ; name: libaot-System.Private.CoreLib.dll.so
		ptr null; void* handle
	}, ; 22
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x07beacdb979b7ff9, ; from name: aot-TimeForBattle.dll.so
		i64 u0x90b1801039f4619a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TimeForBattle.dll.so
		ptr null; void* handle
	}, ; 30
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.101_name, ; name: libaot-Mono.Android.Runtime.dll.so
		ptr null; void* handle
	}, ; 62
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x1784a020b53dabf0, ; from name: libaot-TimeForBattle.so
		i64 u0x90b1801039f4619a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TimeForBattle.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x1b179057ae4619f0, ; from name: TimeForBattle
		i64 u0x90b1801039f4619a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TimeForBattle.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.97_name, ; name: libaot-System.Xml.ReaderWriter.dll.so
		ptr null; void* handle
	}, ; 100
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.61_name, ; name: libaot-System.Collections.Immutable.dll.so
		ptr null; void* handle
	}, ; 170
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.98_name, ; name: libaot-System.dll.so
		ptr null; void* handle
	}, ; 186
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.100_name, ; name: libaot-Java.Interop.dll.so
		ptr null; void* handle
	}, ; 230
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x6ae35bf95b803d3f, ; from name: TimeForBattle.so
		i64 u0x90b1801039f4619a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TimeForBattle.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x90b1801039f4619a, ; from name: libaot-TimeForBattle.dll.so
		i64 u0x90b1801039f4619a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TimeForBattle.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb209251548480581, ; from name: aot-TimeForBattle.so
		i64 u0x90b1801039f4619a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TimeForBattle.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdfe2e6e98a38bc56, ; from name: TimeForBattle.dll.so
		i64 u0x90b1801039f4619a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TimeForBattle.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe5329f4b430dd4eb, ; from name: libaot-TimeForBattle
		i64 u0x90b1801039f4619a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TimeForBattle.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf2da7cd53d5decf9, ; from name: aot-TimeForBattle
		i64 u0x90b1801039f4619a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TimeForBattle.dll.so
		ptr null; void* handle
...
@dso_apk_entries = dso_local local_unnamed_addr global [104 x %struct.DSOApkEntry] zeroinitializer, align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.companyname.timeforbattle\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [28 x i8] c"libaot-TimeForBattle.dll.so\00", align 16
...
@.DSOCacheEntry.61_name = private unnamed_addr constant [43 x i8] c"libaot-System.Collections.Immutable.dll.so\00", align 16
...
@.DSOCacheEntry.96_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 16
@.DSOCacheEntry.97_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 16
@.DSOCacheEntry.98_name = private unnamed_addr constant [21 x i8] c"libaot-System.dll.so\00", align 16
@.DSOCacheEntry.99_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
@.DSOCacheEntry.100_name = private unnamed_addr constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 16
@.DSOCacheEntry.101_name = private unnamed_addr constant [35 x i8] c"libaot-Mono.Android.Runtime.dll.so\00", align 16
@.DSOCacheEntry.102_name = private unnamed_addr constant [27 x i8] c"libaot-Mono.Android.dll.so\00", align 16
@.DSOCacheEntry.103_name = private unnamed_addr constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 16
