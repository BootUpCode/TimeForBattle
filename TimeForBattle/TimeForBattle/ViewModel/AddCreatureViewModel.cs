...
public partial class AddCreatureViewModel : BaseViewModel
{
    ...
    public async Task ImportText()
    {
        ...
        [
            ...
            @"(?<size>Small|Medium|Large|Huge|Gargantuan) ([a-zA-Z() ]+)",
            ...
            @"Actions\s*((?:(?!Bonus actions|Reactions|Legendary actions|Habitat|Treasure|Source).)*)",
            @"Bonus actions\s*((?:(?!Reactions|Legendary actions|Habitat|Treasure|Source).)*)",
            @"Reactions\s*((?:(?!Legendary actions|Habitat|Treasure|Source).)*)",
            @"Legendary actions\s*((?:(?!Habitat|Treasure|Source).)*)",
