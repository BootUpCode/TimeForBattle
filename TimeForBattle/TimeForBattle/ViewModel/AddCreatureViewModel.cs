...
public partial class AddCreatureViewModel : BaseViewModel
{
    ...
    public async Task ImportText()
    {
        ...
        [
            ...
            @"Actions.*?([A-Za-z ]+)\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?: \+",
            @"Actions.*?[A-Za-z ]+\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?: \+([0-9]+)",
            @"Actions.*?[A-Za-z ]+\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?:.*?\(([0-9]+)d[0-9]+(?: \+ [0-9]+)?\)",
            @"Actions.*?[A-Za-z ]+\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?:.*?\([0-9]+d([0-9]+)(?: \+ [0-9]+)?\)",
            @"Actions.*?[A-Za-z ]+\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?:.*?\([0-9]+d[0-9]+(?:( [+-] [0-9]+)?)\)",
            @"Actions.*?[A-Za-z ]+\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?:.*?(Acid|Bludgeoning|Cold|Fire|Force|Lightning|Necrotic|Piercing|Poison|Psychic|Radiant|Slashing|Thunder|acid|bludgeoning|cold|fire|force|lightning|necrotic|piercing|poison|psychic|radiant|slashing|thunder)",
            @"Actions.*?\([0-9]+d[0-9]+(?: \+ [0-9]+)?\) [A-Za-z]+ damage.*?\..*?([A-Za-z ]+)\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?: \+",
            @"Actions.*?\([0-9]+d[0-9]+(?: \+ [0-9]+)?\) [A-Za-z]+ damage.*?\..*?[A-Za-z ]+\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?: \+([0-9]+)",
            @"Actions.*?\([0-9]+d[0-9]+(?: \+ [0-9]+)?\) [A-Za-z]+ damage.*?\..*?[A-Za-z ]+\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?:.*?\(([0-9]+)d[0-9]+(?: \+ [0-9]+)?\)",
            @"Actions.*?\([0-9]+d[0-9]+(?: \+ [0-9]+)?\) [A-Za-z]+ damage.*?\..*?[A-Za-z ]+\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?:.*?\([0-9]+d([0-9]+)(?: \+ [0-9]+)?\)",
            @"Actions.*?\([0-9]+d[0-9]+(?: \+ [0-9]+)?\) [A-Za-z]+ damage.*?\..*?[A-Za-z ]+\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?:.*?\([0-9]+d[0-9]+( [+-] [0-9]+)?\)",
            @"Actions.*?\([0-9]+d[0-9]+(?: \+ [0-9]+)?\) [A-Za-z]+ damage.*?\..*?[A-Za-z ]+\. [A-Za-z ]+Attack(?:[A-Za-z ]+)?:.*?(Acid|Bludgeoning|Cold|Fire|Force|Lightning|Necrotic|Piercing|Poison|Psychic|Radiant|Slashing|Thunder|acid|bludgeoning|cold|fire|force|lightning|necrotic|piercing|poison|psychic|radiant|slashing|thunder)",
